...
def test_status_codes(flask_server, user, driver):
    ...
    expected_status_codes = {
        ...
        'admin/automatic_schema_updates/status': 200,
        ...
        f'api/v1/instruments/{instrument_id}/log_entries/{instrument_log_entry_id}/versions/': 200,
        f'api/v1/instruments/{instrument_id}/log_entries/{instrument_log_entry_id}/versions/1': 200,
        ...
        f'api/v1/objects/{object_id}/related_objects': 200,
